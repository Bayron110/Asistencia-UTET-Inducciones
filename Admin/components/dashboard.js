...
let filtroCarreraLive    = 'todas';     // filtro carrera en tabla viva
let filtroCarreraChart   = 'todos';     // filtro chart barras
let vistaCarrera         = 'barras';
let chartInstance        = null;
let listenerIniciado     = false;
let listenerGrupoIniciado= false;

// filtros por grupo histórico
const dashGrupoCarrera   = {};  // { grupoId: 'todas' | nombre }
const dashGrupoAbierto   = {};  // { grupoId: bool }
...
/* ═══════════════════════════════════════
   TABLA VIVA (con filtro de carrera)
═══════════════════════════════════════ */
function renderTablaViva(){
  ...
  // Actualizar contadores chips asistencia
      ...
      <div style="border:1px solid rgba(255,255,255,.07);border-radius:10px;overflow:hidden;margin:0 16px 16px;">
        <div style="overflow-x:auto;max-height:300px;overflow-y:auto;">
          <table class="dash-table">
            <thead>
              <tr>
                <th>#</th><th>Cédula</th><th>Nombre / Carrera</th><th>Estado</th>
              </tr>
            </thead>
